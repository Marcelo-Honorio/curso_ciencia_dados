...
Um **Histograma** é um jeito de visualizar um tabela frequência.
...
O R referência os dados ausentes como `NA`{style="color:red"}, que quer dizer Not Available(indisponível).
